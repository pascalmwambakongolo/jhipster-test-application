...
To build the final jar and optimize the testOne application for production, run:
...
Then navigate to [http://localhost:2921](http://localhost:2921) in your browser.
